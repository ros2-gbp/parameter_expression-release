...
%global pkg_name parameter_expression
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-parameter-expression
Version:        0.0.2
Release:        3%{?dist}
...
%changelog
* Wed Apr 29 2026 f0reachARR <f0reach@f0reach.me> - 0.0.2-3
- Autogenerated by Bloom

* Tue Apr 28 2026 f0reachARR <f0reach@f0reach.me> - 0.0.2-2
- Autogenerated by Bloom

* Tue Apr 21 2026 f0reachARR <f0reach@f0reach.me> - 0.0.2-1
- Autogenerated by Bloom
